    ...
    <div class="card">
        <div class="card-header">
            <div class="card-title">
                <a href="<?= site_url('colour') ?>" class="btn mb-1 btn-rounded btn-warning">
            ...
            <div class="card-body">
                <div class="row justify-content-center">
                    <div class="col-md-5">
                        <?php ?>
                        <form action="<?= site_url('colour/process') ?>" method="post">
                            <div class="form-group">
                                <label class="text-center">Nama Warna *</label>
                                <input type="hidden" name="id" value="<?= $row->colour_id ?>">
                                <input type="text" name="colour_name" value="<?= $row->name ?>" class="form-control" required>
                            </div>
